...
def plan_session(config: dict, repo_root: Path, cuda_devices: int = 0, vram_gb: float = 0) -> SessionPlan:
    ...
    recommendations = recommend_tuning(planned, cuda_devices, vram_gb)
