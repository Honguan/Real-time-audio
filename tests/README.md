...
- Real Windows audio hardware remains a manual release check. CI builds an app-only installer and smoke-tests its packaged EXE; the release workflow repeats the packaged smoke test after Authenticode signing.
